...
function Sidebar() {
    ...
    return (
        <>
            ...
            <aside
                id="logo-sidebar"
                style={{ backgroundColor: '#13345A', borderRight: '1px solid white' }}
                className={`fixed top-0 left-0 z-40 w-60 h-screen transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 bg-gray-50`}
                aria-label="Sidebar"
            >
                        ...
                        <li>
                            <div>
                                ...
                                <div className={`mt-2 space-y-2 ${isDropdownOpen ? 'block' : 'hidden'}`}>
                                    <a href="-" className="block px-4 py-2" style={{ color: '#B8C1CD' }}>Customers</a>
